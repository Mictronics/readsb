(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    window.LayerSwitcher = factory(window.ol);
  }
}(this, (ol) => {
  /**
  ...
  ol.control.LayerSwitcher.prototype.ensureTopVisibleBaseLayerShown_ = function () {
    ...
    ol.control.LayerSwitcher.forEachRecursive(this.getMap(), (
      l,
      idx,
      a,
    ) => {
  ...
  ol.control.LayerSwitcher.prototype.setVisible_ = function (lyr, visible) {
    ...
    if (visible && lyr.get('type') === 'base') {
      ...
      ol.control.LayerSwitcher.forEachRecursive(map, (l, idx, a) => {
  ...
  ol.control.LayerSwitcher.prototype.renderLayer_ = function (lyr, idx) {
    ...
    const lyrId = ol.control.LayerSwitcher.uuid();
  ...
  const { LayerSwitcher } = ol.control;
